...
function ProfilePage() {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await axios.get(`http://localhost:8080/public/get-users/${id}`);
            ...
            <div className="col-md-8">
              <div className="p-3 py-5">
                ...
                <div className="row mt-3">
                  <div className="col-md-6"><label className="labels">Họ</label><input type="text" className="form-control" placeholder={getValue(profile, 'userAccountData.lastName')} readOnly /></div>
                  <div className="col-md-6"><label className="labels">Tên</label><input type="text" className="form-control" placeholder={getValue(profile, 'userAccountData.firstName')} readOnly /></div>
                </div>
                <div className="row mt-3">
                ...
                <div className="mt-5">
                  ...
                  <div className="col-md-12"><label className="labels">Ngành nghề</label><input type="text" className="form-control" placeholder={getValue(profile, 'userSettingData.categoryJobCode')} readOnly /></div>
                  <div className="col-md-12"><label className="labels">Địa điểm làm việc</label><input type="text" className="form-control" placeholder={getValue(profile, 'userSettingData.addressCode')} readOnly /></div>
                  <div className="col-md-12"><label className="labels">Mức lương mong muốn</label><input type="text" className="form-control" placeholder={getValue(profile, 'userSettingData.salaryJobCode')} readOnly /></div>
                  <div className="col-md-12"><label className="labels">Kinh nghiệm</label><input type="text" className="form-control" placeholder={getValue(profile, 'userSettingData.experienceJobCode')} readOnly /></div>
                </div>
                <div className="mt-5">
                  <h4>Kỹ năng</h4>
                ...
                <div className="mt-5">
                  <h4>CV</h4>
                  {profile.userSettingData && profile.userSettingData.file ? (
                    <div>
                      <a 
                        href={createPdfUrl(profile.userSettingData.file)}
                        download="CV.pdf" 
                      ...
                      <div className="embed-responsive embed-responsive-4by3">
                        <iframe 
                          ...
                          src={createPdfUrl(profile.userSettingData.file)}
                          title="CV Preview"
                        />
                      </div>
                    </div>
